...
if (!isset($_SESSION['vdate']) || !isset($_SESSION['vid']) || !isset($_SESSION['vcart'])) {
  header("location:page-list-purchase.php");
}

$vdate = $_SESSION['vdate'];
$vid = $_SESSION['vid'];
$vcart = $_SESSION['vcart'];

include "../connection.php";
$ll = "SELECT * FROM purchase WHERE cartno = '$vcart' AND purdate = '$vdate' AND supplier = '$vid' ";
$lexe = mysqli_query($conn,$ll);
$cpy = mysqli_query($conn,$ll);
if (mysqli_num_rows($lexe) == 0) {
    $ll = "SELECT * FROM purchase WHERE cartno = '$vcart' AND purdate = '$vdate' AND supplier = '$vid' LIMIT 0";
    $lexe = mysqli_query($conn,$ll);
    $cpy = mysqli_query($conn,$ll);
}
...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <title>SHOP | View Purchase</title>
  ...
  <script type="text/javascript">
    ...
    function print_content(){
      ...
      a.document.write('<br><br><center><h3 style=""><b><u>Purchase Invoice</u></b></h3><br>');
      a.document.write('<table border="1" style="width:100%;"><thead><tr><th>S.N0.</th><th>Category</th><th>Code</th><th>Name</th><th>Brand</th><th>Quantity</th><th>Cost</th><th>MRP</th><th>Tax(in %)</th><th>Discount(in %)</th><th>Amount</th></tr></thead>');
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                $gg = "SELECT purid FROM purchase WHERE cartno = '$vcart' AND purdate = '$vdate' AND supplier = '$vid' ";
                                $ee = mysqli_query($conn,$gg);
                                $pur = mysqli_fetch_array($ee);
                                echo $pur[0];
                                 ?></h4>
                                 <p id="d1" style="display:none;">
                                     DATE : <?php echo $vdate; ?><br>PURCHASE ID :<?php echo $pur[0]; ?>
                                 </p>
                            </div>
                            <div class="col-md-5">
                                <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-4"><h4 class="h5 text-black">Supplier : Details</h4></div>
                                    <?php include "../connection.php";
                                        $gg = "SELECT * FROM suppliers WHERE sid = '$vid' ";
                                        $ee = mysqli_query($conn,$gg);
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <p id="d3" style="display:none;">
                                            Supplier Details :<br>Name : <?php echo $row[1]; ?><br>GST/Company : <?php echo $row[6].'/'.$row[2]; ?><br>Email : <?php echo $row[3]; ?><br>Phone : <?php echo $row[4]; ?>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                <h4 class="h5 text-black">Products Purchased</h4>
                                 ...
                                 <tbody id="print_area">
                                    <?php if (mysqli_num_rows($lexe) > 0) {
                                       while ($listdata = mysqli_fetch_array($lexe)) {
                                        $getpid = $listdata[3];
                                        $ll1 = "SELECT * FROM billpurchase WHERE bpdate ='$vdate' AND bpsid = '$vid' AND cartno = '$vcart' ";
                              ...
                              <table id="tbl_exporttable_to_xls" style="display:none;" class="text-center w-100" border="2" role="grid" aria-describedby="user-list-page-info">
                                 <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th></th>
                                        <th>GST/Company :</th>
                                        <th><b><?php echo $row[6].'/'.$row[2]; ?></b></th>
                                    </tr>
                                    <tr>
                                        <th></th>
                                        <th></th>
                            ...
                            <div class="row col-md-12">
                                <div class="col-md-5">
                                    <br>
                                    <h4 class="h5 text-black">Purchase Products Status : <b><?php echo $listdata[5]; ?></b></h4>
                                    <h4 class="h5 text-black">Payment Status : <b><?php echo $listdata[9]; ?></b></h4>
                                    <h4 class="h5 text-black">Mode Of Payment : <b><?php echo $listdata[10]; ?></b></h4>
                                </div> 
                                <div class="col-md-4 ">
                                    <br>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <br>
                                    <hr>
                                    <h4 style="position: absolute;left: 15px;" class="h5 text-black"><b><?php echo '₹ '.$listdata[8]; ?></b></h4>
                                    <br>
                                </div>
                                <p id="d4" style="display:none;">
                                    <b>Purchase Products Status : <?php echo $listdata[5]; ?><br>Payment Status : <?php echo $listdata[9];?><br>Mode Of Payment : <?php echo $listdata[10]; ?></b>
                                </p>
                                <p id="d5" style="display:none;">
                                    <b>Total Amount : <?php echo '₹ '.$listdata[6]; ?><br>Paid : <?php echo '₹ '.$listdata[7]; ?><br>Due : <?php echo '₹ '.$listdata[8]; ?></b>
                                </p>
                                    <?php }
                                    } ?>
                            </div>
