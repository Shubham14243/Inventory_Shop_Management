...
$ll = "SELECT * FROM suppliers ORDER BY sid DESC";
$lexe = mysqli_query($conn,$ll);
if (mysqli_num_rows($lexe) == 0) {
   $ll = "SELECT * FROM suppliers ORDER BY sid DESC LIMIT 0";
   $lexe = mysqli_query($conn,$ll);
}
...
if (isset($_REQUEST['getsch'])) {
   ...
   include "../connection.php";
   if ($sch != "") {
      $ll = "SELECT * FROM suppliers WHERE name = '$sch' ";
      $lexe = mysqli_query($conn,$ll);
   }else{
      $ll = "SELECT * FROM suppliers";
      $lexe = mysqli_query($conn,$ll);
   }
}
...
if (isset($_REQUEST['upd'])) {
   ...
   header("location:page-edit-suppliers.php");
}

if (isset($_REQUEST['dele'])) {
   include "../connection.php";
   $gdid = $_REQUEST['getid'];
   $sql2 = "DELETE FROM suppliers WHERE sid ='$gdid' ";
   ...
   if ($exe2) {
      ...
      mysqli_close($conn);
      echo '<script>alert("Supplier Not Deleted!");</script>';
   }   
}
...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <title>SHOP | Supplier List</title>
  ...
  <script type="text/javascript">
    ...
    function print_content(){
      ...
      a.document.write('<body><center><h2>Suppliers List</h2><br><table border="1"><thead><tr><th>ID</th><th>Name</th><th>Company Name</th><th>Email</th><th>Phone</th><th>GST NO</th><th>Address</th></tr></thead>');
      a.document.write(divContents);
      a.document.write('</table></center></body></html>');
      a.document.close();
      a.print();
      window.location.replace('page-list-suppliers.php');
    }
         ...
         <div class="card">
            <div class="card-header d-flex justify-content-between">
               <div class="header-title">
                  ...
                  <a style="position: absolute;right: 2%;top:3%;" class="btn btn-primary" href="page-add-supplier.php">Add Supplier</a>
               </div>
            </div>
            <div class="card-body">
